...
| [Lists](lists.md) | FileList, CaseList, AttributeList, QueueList | Collection displays |
...
| [Document](document.md) | TextPanel, TranscriptPanel, SelectionPopup, TextColor | Document handling |
