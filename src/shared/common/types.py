...
class DomainEvent:
    ...
    Subclasses MUST define an explicit event_type class variable:
        event_type: ClassVar[str] = "context.entity_action"

    Convention for event_type:
        Success: {context}.{entity}_{action}  (e.g., "coding.code_created")
        Failure: {ENTITY}_NOT_{ACTION}/{REASON}  (e.g., "CODE_NOT_CREATED/DUPLICATE_NAME")
    """

    # Subclasses must define this ClassVar
