...
if TYPE_CHECKING:
    from src.shared.infra.app_context import CasesContext, CodingContext
...
class SourceSyncHandler:
    ...
    def start(self) -> None:
        ...
        self._event_bus.subscribe_type(SourceRenamed, self._on_source_renamed)
        self._event_bus.subscribe_type(SourceRemoved, self._on_source_removed)
    ...
    def stop(self) -> None:
        ...
        self._event_bus.unsubscribe(SourceRenamed.event_type, self._on_source_renamed)
        self._event_bus.unsubscribe(SourceRemoved.event_type, self._on_source_removed)
        self._subscribed = False
