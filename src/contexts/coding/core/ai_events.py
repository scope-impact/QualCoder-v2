"""
Coding Context: AI-Assisted Coding Events

Domain events for AI-assisted coding operations:
- Code suggestions
- Duplicate detection and merge suggestions

Event type convention: coding.ai_{entity}_{action}
"""
...
from src.shared.common.types import CodeId, DomainEvent, SourceId
...
class CodeSuggested(DomainEvent):
    """AI proposed a new code based on text analysis."""

    event_type: ClassVar[str] = "coding.ai_code_suggested"
...
class CodeSuggestionApproved(DomainEvent):
    ...
    event_type: ClassVar[str] = "coding.ai_code_suggestion_approved"
...
class CodeSuggestionRejected(DomainEvent):
    ...
    event_type: ClassVar[str] = "coding.ai_code_suggestion_rejected"
...
class DuplicatesDetected(DomainEvent):
    """AI found potentially duplicate codes."""

    event_type: ClassVar[str] = "coding.ai_duplicates_detected"
...
class MergeSuggested(DomainEvent):
    """AI recommended merging two similar codes."""

    event_type: ClassVar[str] = "coding.ai_merge_suggested"
...
class MergeSuggestionApproved(DomainEvent):
    ...
    event_type: ClassVar[str] = "coding.ai_merge_suggestion_approved"
...
class MergeSuggestionDismissed(DomainEvent):
    ...
    event_type: ClassVar[str] = "coding.ai_merge_suggestion_dismissed"
...
# All AI-assisted coding events
AICodingEvent = SuggestionEvent | DuplicateEvent
