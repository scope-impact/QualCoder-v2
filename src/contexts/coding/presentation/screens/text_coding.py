...
from src.contexts.coding.presentation.services import AutoCodingController
from src.shared.presentation.dto import TextCodingDataDTO, create_empty_text_coding_data
...
class TextCodingScreen(QWidget):
    ...
    def __init__(
        ...
        # Determine data source: viewmodel, provided data, or empty placeholder
