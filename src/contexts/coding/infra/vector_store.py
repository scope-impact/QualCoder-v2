...
if TYPE_CHECKING:
    from src.contexts.coding.infra.config import EmbeddingConfig, VectorStoreConfig
...
def create_vector_store(
    ...
    """
    from src.contexts.coding.infra.embedding_provider import create_embedding_provider
