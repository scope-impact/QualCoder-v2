"""
AI Services Context: Failure Events

Publishable failure events for the AI services bounded context.
...
from src.contexts.ai_services.core.entities import SuggestionId
