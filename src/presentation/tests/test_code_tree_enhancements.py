...
class TestCodeTreeScreenshot:
    """Visual tests with screenshots."""

    def test_screenshot_filtered_tree(self, qapp, colors, take_screenshot):
        """Screenshot of filtered code tree."""
        from src.presentation.organisms.codes_panel import CodesPanel
        ...
        panel.set_codes(
            [
                ...
                },
                {
                    "name": "Contexts",
                    "codes": [
                        {"id": "5", "name": "Home", "color": "#9C27B0", "count": 7},
                        {"id": "6", "name": "Office", "color": "#00BCD4", "count": 4},
                    ],
                },
            ]
        )

        panel.setFixedSize(280, 400)
        take_screenshot(panel, "code_tree_with_data")
