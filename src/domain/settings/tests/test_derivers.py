...
class TestDeriveThemeChange:
    ...
    def test_changes_theme_with_valid_input(self):
        ...
        from src.domain.settings.derivers import derive_theme_change
    ...
    def test_fails_with_invalid_theme(self):
        ...
        from src.domain.settings.derivers import InvalidTheme, derive_theme_change
        from src.domain.settings.entities import UserSettings
...
class TestDeriveFontChange:
    ...
    def test_changes_font_with_valid_inputs(self):
        ...
        from src.domain.settings.derivers import derive_font_change
        from src.domain.settings.entities import UserSettings
    ...
    def test_fails_with_invalid_font_family(self):
        ...
        from src.domain.settings.derivers import InvalidFontFamily, derive_font_change
        from src.domain.settings.entities import UserSettings
    ...
    def test_fails_with_font_size_too_small(self):
        ...
        from src.domain.settings.derivers import InvalidFontSize, derive_font_change
        from src.domain.settings.entities import UserSettings
...
class TestDeriveLanguageChange:
    ...
    def test_changes_language_with_valid_code(self):
        ...
        from src.domain.settings.derivers import derive_language_change
        from src.domain.settings.entities import UserSettings
    ...
    def test_fails_with_invalid_language_code(self):
        ...
        from src.domain.settings.derivers import InvalidLanguage, derive_language_change
        from src.domain.settings.entities import UserSettings
