...
E2E tests verify the full integration stack:
...
See `src/presentation/tests/test_case_manager_e2e.py` for a complete example.
...
- [ ] E2E tests use real database fixtures (not mocks)
