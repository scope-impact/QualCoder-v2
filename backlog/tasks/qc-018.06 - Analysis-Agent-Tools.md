...
MCP tools: get_code_frequency (AUTONOMOUS), get_co_occurrence (AUTONOMOUS), query_codes (AUTONOMOUS), search_text (AUTONOMOUS). Enable AI analytical questions.
<!-- SECTION:DESCRIPTION:END -->

## Acceptance Criteria
<!-- AC:BEGIN -->
### MCP Tool Schemas (All AUTONOMOUS - read-only analysis)
