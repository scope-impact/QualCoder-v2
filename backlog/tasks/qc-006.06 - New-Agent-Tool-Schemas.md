...
Add MCP tool schemas for auto-coding and media coding operations. Register with MCP server.
...
- [ ] #8 Schemas registered with MCP server on startup
- [ ] #9 Resource URIs defined: `qualcoder://coding/tools/{tool_name}`

### Controller Integration
- [ ] #10 Each MCP tool invokes corresponding Controller command
- [ ] #11 Controller returns Result[Event, Failure] → MCP returns success/error
